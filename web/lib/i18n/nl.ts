...
export const nl: Dictionary = {
  ...
  zine: {
    ...
    hover_notes: ["BEWIJS???", "WACHT…", "TOEVAL?", "VERDACHT!", "VERBONDEN!", "HEBBES"],
    receipts_stamp: "BEWIJS!",
    exercise_not_manifesto: "Een oefening · geen manifest",
    tonights_exclusive: "Exclusief vanavond",
    you_can_be_a_conspiracist: "JIJ kunt een\ncomplotdenker zijn*",
    educational_purposes_only: "*alleen voor educatieve doeleinden",
    four_moves_youll_learn: "De vier zetten die je leert:",
    free_in_classrooms: "Gratis in de klas",
    lesson_plan_blurb: "Open het menu *Lesplan* voor een lesmodule van 45 minuten en een printbaar werkblad.",
    one_hundred_percent_fabricated: "100% verzonnen",
    expose_for_instructional: "Onthulling · voor educatieve doeleinden",
    built_in_three_minutes: "In 3 minuten door jou gebouwd",
    do_not_share_without_context: "niet delen zonder context",
    marker_caption: "↑ de rood gemarkeerde woorden komen uit jouw keuzes.",
    back_a_step: "← een stap terug",
    move_n_of_n: "Zet {n} van {total}",
    your_theory: "Jouw theorie",
    the_move: "De zet",
    as_told_by_you: "Verteld door jou, de leerling-complotdenker:",
    now_show_me_debunk: "⚠ Laat nu de debunk zien",
    why_it_doesnt_hold_up: "Waarom het niet klopt",
    back_to_the_theory: "↺ Terug naar de theorie",
    next_move: "Volgende zet →",
    see_the_whole_thing: "Zie het geheel →",
    save_poster: "↓ Poster opslaan",
    build_another: "↺ Bouw nog een",
    start_the_exercise: "▸ Start de oefening",
    takes_three_minutes: "duurt 3 minuten!!",
    the_four_moves_title: "De vier zetten.",
    recipe_eyebrow: "Receptpagina",
    lesson_plan_eyebrow: "Voor docenten",
    lesson_plan_title: "Lesplan · 45 min.",
    lesson_plan_audience: "Voortgezet · universiteit · mediawijsheid",
    debunk_label: "Debunk",
    debunk_sticker: "Debunk",
    your_theory_sticker: "Jouw theorie",
    useful_test: "Een nuttige test:",
    useful_test_body: "vraag jezelf af of dezelfde redenering net zo makkelijk de *tegenovergestelde* conclusie zou kunnen bewijzen. Zo ja, dan is het een retorische zet, geen aanwijzing.",
    what_you_just_learned: "Wat je net geleerd hebt:",
    what_you_just_learned_body: "dezelfde kop kan tientallen tegenstrijdige complottheorieën voeden. Dat is een kenmerk van het genre, geen fout — en een handig signaal als je er in het wild een tegenkomt.",
    official_story: "Het officiële verhaal",
    what_they_dont_want: "Wat \"zij\" niet willen dat je weet:",
