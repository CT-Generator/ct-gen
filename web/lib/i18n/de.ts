...
export const de: Dictionary = {
  ...
  wizard: {
    ...
    recap_label: "Die Geschichte",
    recap_toggle_open: "Was war nochmal passiert?",
    recap_toggle_close: "Geschichte ausblenden",
    recap_source_label: "Quelle",
  ...
  zine: {
    ...
    hover_notes: ["BEWEIS???", "MOMENT…", "ZUFALL?", "VERDÄCHTIG!", "VERBUNDEN!", "ERWISCHT"],
    receipts_stamp: "BEWEISE!",
    exercise_not_manifesto: "Eine Übung · kein Manifest",
    tonights_exclusive: "Heute exklusiv",
    you_can_be_a_conspiracist: "DU kannst ein\nVerschwörer sein*",
    educational_purposes_only: "*nur zu Bildungszwecken",
    four_moves_youll_learn: "Die vier Schritte, die du lernst:",
    free_in_classrooms: "Kostenlos im Unterricht",
    lesson_plan_blurb: "Öffne das Menü *Unterrichtsplan* für eine 45-Minuten-Einheit und ein druckbares Arbeitsblatt.",
    one_hundred_percent_fabricated: "100% erfunden",
    expose_for_instructional: "Enthüllung · zu Lehrzwecken",
    built_in_three_minutes: "In 3 Minuten von dir gebaut",
    do_not_share_without_context: "nicht ohne Kontext teilen",
    marker_caption: "↑ die rot markierten Wörter stammen aus deinen Entscheidungen.",
    back_a_step: "← einen Schritt zurück",
    move_n_of_n: "Schritt {n} von {total}",
    your_theory: "Deine Theorie",
    the_move: "Der Schritt",
    as_told_by_you: "Erzählt von dir, dem Verschwörer-Lehrling:",
    now_show_me_debunk: "⚠ Jetzt zeig mir den Debunk",
    why_it_doesnt_hold_up: "Warum es nicht standhält",
    back_to_the_theory: "↺ Zurück zur Theorie",
    next_move: "Nächster Schritt →",
    see_the_whole_thing: "Das Ganze sehen →",
    save_poster: "↓ Poster speichern",
    build_another: "↺ Noch eine bauen",
    start_the_exercise: "▸ Übung starten",
    takes_three_minutes: "dauert 3 Minuten!!",
    the_four_moves_title: "Die vier Schritte.",
    recipe_eyebrow: "Rezeptseite",
    lesson_plan_eyebrow: "Für Lehrkräfte",
    lesson_plan_title: "Unterrichtsplan · 45 Min.",
    lesson_plan_audience: "Sek II · Universität · Medienkompetenz",
    debunk_label: "Debunk",
    debunk_sticker: "Debunk",
    your_theory_sticker: "Deine Theorie",
    useful_test: "Ein nützlicher Test:",
    useful_test_body: "frag dich, ob dieselbe Argumentation ebenso leicht die *gegenteilige* Schlussfolgerung beweisen könnte. Wenn ja, ist es ein rhetorischer Zug, kein Hinweis.",
    what_you_just_learned: "Was du gerade gelernt hast:",
    what_you_just_learned_body: "Dieselbe Schlagzeile kann Dutzende widersprüchlicher Verschwörungstheorien speisen. Das ist ein Merkmal des Genres, kein Fehler — und ein nützliches Erkennungszeichen, wenn dir eine in freier Wildbahn begegnet.",
    official_story: "Die offizielle Version",
    what_they_dont_want: "Was \"sie\" nicht wollen, dass du weißt:",
