  ...
  const system =
    locale === "de"
      ? [
          ...
          "Die vier Eingabe-Absätze (Auffälligkeit, Verbindung, Abwehr, Diskreditierung) sind deine NOTIZEN — Rohmaterial, gesammelt von einem misstrauischen Kopf. Sie sind keine Abschnitte, die brav abgearbeitet werden müssen. Deine Aufgabe: aus diesen Notizen eine einzige zusammenhängende, spitzbübische, seltsam zwingende Verschwörungstheorie schmieden. Kohärenz und Witz zählen mehr als Vollständigkeit.",
          "",
          "Gib GENAU VIER Absätze aus.",
          "  Absatz 1 (50–80 Wörter): eine kurze, sachlich-journalistische Einordnung des realen Nachrichtenereignisses, das den Hintergrund bildet. Nenne das Ereignis beim Namen. Schreibe NICHT in der Stimme der Verschwörungstheoretikerin.",
          "  AUFBAU VON ABSATZ 1 — verbindlich: Schildere zuerst, was passiert ist und wie es behördlich eingeordnet wurde, und hänge die Wendung „… so jedenfalls die offizielle Version.“ UNMITTELBAR an diese institutionelle Einordnung an. Zweifel, Widersprüche, verschwundene Belege oder offene Fragen dürfen NICHT vor der Wendung stehen. Wenn du Zweifel überhaupt erwähnen willst, kommen sie in einem einzelnen Satz NACH der Wendung, als das erste Hineinlehnen der Verschwörungstheoretikerin.",
          "  FALSCH (Wendung an die Zweifel gehängt — die Leserin hält die Zweifel für die offizielle Version): „Am 14. März 2024 fiel in Nordspanien für sechs Stunden das Stromnetz aus; die Behörden führten den Ausfall auf ein defektes Umspannwerk zurück. Die Ermittlungen verfolgten widersprüchliche Spuren, zentrale Protokolle gingen verloren, viele Fragen blieben offen – so jedenfalls die offizielle Version.“",
          "  RICHTIG (Wendung klammert sich an die institutionelle Einordnung; Zweifel kommen danach): „Am 14. März 2024 fiel in Nordspanien für sechs Stunden das Stromnetz aus; die Behörden führten den Ausfall auf ein defektes Umspannwerk zurück – so jedenfalls die offizielle Version. Die Ermittlungen verfolgten widersprüchliche Spuren, und zentrale Protokolle gingen verloren.“",
          "  Absätze 2–4 (je 80–140 Wörter): die Verschwörungstheorie selbst — erzählt als eine fortlaufende Geschichte, in der Stimme einer überzeugten Verschwörungstheoretikerin, leicht spitzbübisch, satirisch, hineingelehnt.",
          "",
          "Wie du mit den vier Notizen umgehst:",
          "- Such dir die stärksten Beats aus allen vier Notizen heraus; baue um, ordne neu, verschmelze, lass Langweiliges weg.",
          "- Jeder der vier Schritte soll eine erkennbare SPUR hinterlassen — wer hinsieht, soll alle vier wiederfinden können. Ein flüchtiger Satz reicht aus. Vollständige Wiedergabe ist NICHT das Ziel.",
          "- Paraphrasiere die Notizen NICHT Absatz für Absatz. Eine Leserin darf nicht auf Absatz 2 zeigen und sagen können: „Ah, hier kommt die Auffälligkeit.“ Die Schritte sind das Skelett der Logik, nicht die Gliederung der Absätze.",
          "- ERFINDE Verbindendes: atmosphärische Details, eine eingeworfene Bemerkung, ein griffiges Bild, ein zweifelhaftes Insider-Detail, ein „was man dir nicht sagt“-Einwurf. Erfundenes ist erwünscht, solange es den Notizen oder dem echten Ereignis nicht offen widerspricht.",
          "- Lass einen Schritt dominieren, wenn er die stärkste Erzählung trägt; lass einen anderen vielleicht nur in einem einzigen scharfen Satz aufblitzen.",
          "- Ziele auf eine Pointe oder einen höhnischen Schluss. Die Stimmung des Diskreditierungs-Schrittes liefert oft die schließende Energie, auch wenn nicht ihr konkreter Inhalt.",
          "- LANDUNG — verbindlich: Absatz 4 MUSS mit einem einzigen zusammenfassenden Satz enden, der die schuldige Partei, das Ereignis und das Motiv ausdrücklich beim Namen nennt — eine letzte, triumphierende Benennung im Sinne von „Das alles zeigt: [Schuldige] steckt hinter [Ereignis], und zwar aus [Motiv].“ Das ist die Pointe der Theorie; nicht abschwächen, nicht andeuten, nicht in der Mitte des Absatzes verstecken. Verwende exakt die in den Eingaben genannten Namen für Schuldige, Ereignis und Motiv.",
          "",
          "Stimme und Form:",
          "- Schreibe als überzeugte Gläubige, nicht als analysierende Beobachterin. Behauptungen als Tatsachen, nicht als Hypothesen.",
          "- Kein Titel, keine Überschriften, keine Aufzählungspunkte, keine Nummerierungen, keine Schritte-Labels (z. B. Schritt 01) und keine Absatz-Labels (z. B. „Hintergrund:“).",
          "- Erwähne KEINE Auflösungen oder kritische Einordnung. Die Auflösungen stehen woanders auf der Seite.",
          "- Schreibe wie eine deutsche Muttersprachlerin. Keine Anglizismen.",
          "",
          voice,
          "",
      ...
      ? [
          ...
          "De vier invoer-alinea's (afwijking, verband, afwering, diskwalificatie) zijn je AANTEKENINGEN — ruw materiaal, verzameld door een wantrouwig hoofd. Het zijn geen secties die braaf afgewerkt moeten worden. Je taak: uit deze aantekeningen één samenhangende, ondeugende, vreemd overtuigende complottheorie smeden. Samenhang en geestigheid wegen zwaarder dan volledigheid.",
          "",
          "Lever PRECIES VIER alinea's.",
          "  Alinea 1 (50–80 woorden): een korte, zakelijk-journalistieke kadering van de echte nieuwsgebeurtenis die de achtergrond vormt. Noem de gebeurtenis bij naam. Schrijf NIET in de stem van de complotdenker.",
          "  OPBOUW VAN ALINEA 1 — strikt: vermeld eerst wat er is gebeurd en hoe de autoriteiten het hebben gekwalificeerd, en koppel de wending „… of dat is althans het officiële verhaal.“ DIRECT aan die institutionele kadering. Twijfels, tegenstrijdigheden, verdwenen bewijsmateriaal of onbeantwoorde vragen mogen NIET vóór de wending staan. Wil je twijfels überhaupt noemen, dan komen ze in één enkele zin NA de wending, als het eerste voorover leunen van de complotdenker.",
          "  FOUT (wending aan de twijfels gehangen — de lezer hoort de twijfels als het officiële verhaal): „Op 14 maart 2024 viel in Noord-Spanje zes uur lang het stroomnet uit; de autoriteiten weten de storing aan een defect transformatorstation. Onderzoekers volgden tegenstrijdige sporen, cruciale logs raakten zoek, veel vragen bleven onbeantwoord – of dat is althans het officiële verhaal.“",
          "  GOED (wending klampt zich aan de institutionele kadering; twijfels komen erna): „Op 14 maart 2024 viel in Noord-Spanje zes uur lang het stroomnet uit; de autoriteiten weten de storing aan een defect transformatorstation – of dat is althans het officiële verhaal. Onderzoekers volgden tegenstrijdige sporen, en cruciale logs raakten zoek.“",
          "  Alinea's 2–4 (elk 80–140 woorden): de complottheorie zelf — verteld als één doorlopend verhaal, in de stem van een overtuigde complotdenker, licht ondeugend, satirisch, voorovergebogen.",
          "",
          "Hoe je met de vier aantekeningen omgaat:",
          "- Pak de sterkste momenten uit alle vier aantekeningen; herschik, herorden, smelt samen, laat saaie stukken weg.",
          "- Elk van de vier stappen moet een herkenbaar SPOOR achterlaten — wie kijkt, herkent alle vier. Eén vluchtige zin volstaat. Volledige weergave is NIET het doel.",
          "- Parafraseer de aantekeningen NIET alinea voor alinea. Een lezer mag niet naar alinea 2 kunnen wijzen en zeggen: „Aha, hier komt de afwijking.“ De stappen zijn het skelet van de logica, niet de indeling van de alinea's.",
          "- VERZIN verbindend weefsel: atmosferische details, een terloopse opmerking, een rake vergelijking, een twijfelachtig „insider“-detail, een „wat ze je niet vertellen“-zijsprong. Verzonnen detail is welkom, zolang het de aantekeningen of de echte gebeurtenis niet openlijk tegenspreekt.",
          "- Laat één stap domineren waar die het sterkste verhaal levert; laat een andere desnoods in één scherpe zin opflitsen.",
          "- Mik op een puntige afsluiting. De stemming van de diskwalificatie-stap levert vaak de slotenergie, ook al niet de exacte inhoud.",
          "- LANDING — strikt: alinea 4 MOET eindigen met één samenvattende slotzin die de schuldige, de gebeurtenis en het motief expliciet bij naam noemt — een laatste, triomfantelijke benoeming in de trant van „Dit alles laat zien: [Schuldige] zit achter [Gebeurtenis], en wel uit [Motief].“ Dit is de clou van de theorie; niet afzwakken, niet suggereren, niet halverwege de alinea wegmoffelen. Gebruik exact de in de invoer genoemde namen voor schuldige, gebeurtenis en motief.",
          "",
          "Stem en vorm:",
          "- Schrijf als overtuigde gelovige, niet als analyserende waarnemer. Beweringen als feiten, niet als hypotheses.",
          "- Geen titel, geen koppen, geen opsommingstekens, geen nummering, geen stap-labels (bv. Stap 01) en geen alinea-labels (bv. „Achtergrond:“).",
      ...
      : [
          ...
          "The four input paragraphs (anomaly, connection, dismiss, discredit) are your NOTES — raw material assembled by a paranoid mind. They are not sections to be dutifully summarized. Your job: forge them into one coherent, mischievous, oddly compelling conspiracy theory. Coherence and wit matter more than coverage.",
          "",
          "Produce EXACTLY FOUR paragraphs.",
          "  Paragraph 1 (50–80 words): a brief, neutral journalistic framing of the actual news event that forms the backdrop. Name the event. Do NOT write in the conspiracist's voice.",
          "  STRUCTURE OF PARAGRAPH 1 — strict: state what happened and how authorities classified it, then attach the pivot phrase \"…or so the official story goes.\" DIRECTLY to that institutional classification. Doubts, contradictions, vanished evidence, or unanswered questions MUST NOT appear before the pivot. If you want to name doubts at all, put them in a single sentence AFTER the pivot, as the conspiracist's first lean-in.",
          "  WRONG (pivot tagged onto doubts — reader hears the doubts as the official line): \"On 14 March 2024, a regional power grid in northern Spain failed for six hours; the outage was attributed to a faulty substation. Investigators chased contradictory leads, key logs went missing, many questions remained — or so the official story goes.\"",
          "  RIGHT (pivot clamps to the institutional classification; doubts come after): \"On 14 March 2024, a regional power grid in northern Spain failed for six hours; the outage was attributed to a faulty substation — or so the official story goes. Investigators chased contradictory leads, and key logs went missing.\"",
          "  Paragraphs 2–4 (80–140 words each): the conspiracy theory itself — told as one continuous story, in the voice of a true-believer conspiracist, slightly mischievous, satirical, leaning in.",
          "",
          "How to use the four notes:",
          "- Pick the strongest beats from all four notes; reshape, reorder, fuse, drop the dull bits.",
          "- Every one of the four moves must leave a detectable TRACE — a careful reader should be able to point to all four. A single glancing sentence is enough. Full coverage is NOT the goal.",
          "- Do NOT paraphrase the notes paragraph-by-paragraph. The reader must not be able to point at paragraph 2 and say \"ah, this is the anomaly.\" The moves are the skeleton of the logic, not the outline of the paragraphs.",
          "- INVENT connective tissue: atmospheric detail, a parenthetical aside, a vivid simile, a dubious \"insider\" detail, a \"what they won't tell you\" interjection. Invented detail is welcome as long as it doesn't openly contradict the notes or the real-world event.",
          "- Let one move dominate where it makes the strongest story; let another flash by in a single sharp sentence if that's all the arc needs.",
          "- Aim for a punchline or a sneering close. The discredit move's mood often supplies the closing energy, even if not its exact content.",
          "- LANDING — strict: paragraph 4 MUST end with a single summary sentence that explicitly names the culprit, the event, and the motive — a final, triumphant naming, in the spirit of \"All of this shows: [Culprit] is behind [Event], and they did it for [Motive].\" This is the theory's punchline; do not soften it, do not merely imply it, do not bury it mid-paragraph. Use the exact culprit, event, and motive names given in the input.",
          "",
          "Voice and form:",
          "- Write as a believer, not as an analyst describing the move. State claims as facts, not as hypotheticals.",
          "- No title, no headings, no bullets, no numbering, no move labels (\"Move 01\" etc.), no paragraph labels (\"Background:\" etc.).",
