...
export default async function TeachPage() {
  ...
  return (
    <>
      ...
      <article className="stage print:py-6 print:px-0">
        <div className="flex items-start justify-between gap-4 print:hidden flex-wrap">
          <Sticker color="blue" tilt={-2}>{t.eyebrow}</Sticker>
          <PrintButton label={t.print_button} />
        </div>
        <h1
          className="scream print:text-[28pt]"
        ...
        <p
          className="body print:text-[11pt]"
          style={{ fontSize: "var(--t-body-lg)", lineHeight: 1.6, maxWidth: 720 }}
        >
          {t.intro}
        </p>
        ...
        <section className="mt-10">
          <h2 className="scream print:text-[16pt]" style={{ fontSize: "var(--t-scream-sm)" }}>
            {t.why_h}
          </h2>
...
function PlanStep({
  ...
  return (
    ...
    >
      ...
      <div>
        <h3
          className="scream print:text-[13pt]"
          style={{ fontSize: "var(--t-scream-xs)", lineHeight: 1.05 }}
        >
          {title}
        </h3>
        <p
          className="body print:text-[11pt]"
          style={{ fontSize: "var(--t-body)", lineHeight: 1.55, marginTop: 8 }}
        >
          {body}
        </p>
      </div>
