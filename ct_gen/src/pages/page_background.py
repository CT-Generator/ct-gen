...
def display_page_background():
    ...
    info_1 = "(For a longer background and motivation, see this [blog post](https://maartenboudry.substack.com/p/the-conspiracy-generator) and this [academic paper](https://drive.google.com/file/d/1GMDVLdKfvaFnj8IFDyiRTGH3ePsOO9B7/views))"
