...
The seed catalog SHALL include Dutch source stories that pass an explicit screening rubric. Maarten SHALL hand-pick at least 20 candidates; at least 12 MUST survive screening. Stories are added to `web/data/seed.json` with a `locale: 'nl'` field.
